...
- В выпадающем списке справа от кнопки “Создать лид-форму” отобразятся лид-формы со статусом "В архиве"
...
- Архивированных форм нет, при выборе “В архиве” в выпадающем списке справа от кнопки “Создать лид-форму” появится надпись “Ничего не нашлось”<br>
...
- Поле "Описание формы" - пустое, нажать на кнопку "Продолжить" появится подпись "Обязательное поле"<br>
...
![Пример изображения](img/style.png)
...
- Ввести email-адреса, не соответствующий формату корректного email-адреса, появится подпись "Поле содержит невалидный email"<br>
...
![Пример изображения](img/open-campaign-creation.png)
...
![Пример изображения](img/add-app.png)

![Пример изображения](img/app-page.png)
...
![Пример изображения](img/app-already-saved.png)
