...
- Открыть форму, данные формы совпадают с теми, что вводились
...
- Нажать на кнопку “Сохранить как черновик”, закрепленную у нижней стороны окна браузера, появится подпись “Изменения сохранены" и на (главной странице кампаний)[https://ads.vk.com/hq/dashboard] справа от поисковый строки нажать на выпадающий список, нажать “Черновики”, откроется таблица черновиков, где будет сохраненный ранее черновик 
