...
* Во вкладке "Статус" доступна фильтрация при нажатии соответсвующих кнопок
...
При нажатии на соответсвующий временной промежуток происходит фильтрация по нему:
...
* При нажатии на соответствующий кейс аудитория фильтруется по нему:
