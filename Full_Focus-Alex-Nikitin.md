...
* При переходе на вкладку отображается окно с кнопками
...
* При надажатии на сохраненный фильтр он применяется

![image](https://github.com/user-attachments/assets/6f999429-e160-41da-910e-030fa9170c85)

* При выборе каких-то пунктов настройки можно сбросить все, нажав на соответствующую кнопку
...
* Во вкладке "Статус"
Доступна фильтрация при нажатии соответсвующих кнопок
...
При нажатии соответствующей кнопки выбирается объект рекламы:
Мобильное приложение
Сообщество ВКонтакте
Сайт
Баннерная реклама
Видеореклама
Запись, видео или клип
Реклама в Дзене
HTML5 баннер
...
* Указать дату можно при нажатии на нее, но невозможно установить на позапрошлый год и ранее, а так же на год вперед
...
Можно выделить как временной промежуток для фильтрации:
Сегодня
Вчера
Эта неделя
Прошлая неделя
...
* При нажатии на кнопку аудитория фильтруется по следующим признакам:
...
Ключевые фразы
События на сайте
Подписчики сообществ ВКонтакте
Подписчики OK сообществ
...
* При нажатии кнопки сбросить все выбранные кампании становяться невыбранными
