...
* При выборе каких-то пунктов настройки можно сбросить все, нажав на кнопку нажав на кнопку "Сбросить все"
...
При нажатии кнопки "Мобильное приложение", "Сообщество ВКонтакте", "Сайт", "Баннерная реклама", "Видеореклама", "Запись, видео или клип", "Реклама в Дзене", "HTML5 баннер" , "Премиальное размещение", "Каталог товаров", "Лид-формы", "VK Mini Apps и игры", "Музыка", "Видео и трансляции", "Дзен", "Одноклассники" выбирается объект рекламы.
...
* При нажатии "Существующая аудитория", "Список пользователей", "События в мобильном приложении", "Установки мобильного приложения", "Ключевые фразы", "События на сайте", "Подписчики сообществ ВКонтакте", "Подписчики OK сообществ", "События в рекламной кампании", "События в лид-форме", "Музыканты", "Пользователи VK Mini Apps и игр ВКонтакте" аудитория фильтруется.


![image](https://github.com/user-attachments/assets/956c976d-794e-4fbd-bc17-cc282ce8dfdc)

* При нажатии "Отменить" фильтрация отменяется
* При нажатии "Применить" соответствующая фильтрация применяется

![image](https://github.com/user-attachments/assets/b2731459-fa78-4ffd-869f-e57004ec0c56)

* При нажатии кнопки "Очистить" фильтрация сбрасывается

![image](https://github.com/user-attachments/assets/0d660335-5835-4bf7-bc76-ecd7b60156a9)
