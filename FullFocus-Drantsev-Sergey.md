...
## Настройки
- при изменении любых данных снизу появляется кнопки "Сохраненить" и "Отменить":

![image](https://github.com/user-attachments/assets/96c5e9fc-e2e0-4e8b-8cba-6cfc083cf41b)

- в поле для ввода номера телефона есть ограничение на число вводимых символов (15);
- в поле для ввода номера телефона нет запрета на ввод других символов, кроме цифр:
...
- _не очень удобно_: начинающийся с "8" номер считается неправильным (верные начинаются с "+7"):

![image](https://github.com/user-attachments/assets/4dc71494-1ab1-4b4f-b0a4-0d652e270beb)
![image](https://github.com/user-attachments/assets/814153dc-91bc-4942-bcf8-66d43145f461)
...
- в строке поиска нет ограничения на длину (на скриншоте введено 1262 символа)  ;
