...
- При нажатии на кнопку "Россия" в выпадающем меню страны в качестве валюты ставится "Российский рубль (RUB)"
- При нажатии на любую страну, кроме "России", в выпадающем меню страны в качестве валюты ставится "Доллар США (USD)" с возможностью выбрать "Евро (EUR)"
...
- Если не заполнять обязательные поля "Имя" и "E-mail", то не получится нажать кнопку "Отправить"
