...
- Радио-кнопки "Тип аккаунта" [2] (обязательное поле):
  ...
  > При нажатии на кнопку "Физическое лицо" она становится выбранной, другие кнопки в этом блоке перестают быть выбранными.

  > При нажатии на кнопку "Юридическое лицо" она становится выбранной, другие кнопки в этом блоке перестают быть выбранными.
...
- ФИО
  ...
  >     ```
  >
  > - Если поле ФИО валидно, то ошибок не будет.
  >
  >   - Пример ввода
  >
  >     ```
...
- Поле "Название кабинета" (необязательное поле)
  ...
  > При нажатии кнопки сохранить, сохраняется новое название кабинета
...
- выбранные категории уведомлений сохраняются.
- выбранные способы получения уведомлений сохраняются.
...
- При нажатии на кнопку в колонке права доступа, открывается модальное окно "Редактирование кабинета {ID_Кабинета}"
  - Доступны следующие настройки
    ...
    - Категория "Расширенные права"
      ...
      - Чекбокс "Доступ к кампаниям"
      - Чекбокс "Доступ к финансовой информации"
    - При нажатии кнопки Сохранить, права доступа для кабинета обновляются.
