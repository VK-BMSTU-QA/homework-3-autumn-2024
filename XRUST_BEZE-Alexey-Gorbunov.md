...
1. Добавление пикселя
    ...
    - Сайты. При добавлении пикселя, при вводе некорректного адреса сайта в поле "Домен сайта" и нажатии кнопки "Добавить пиксель" появляется ошибка "Введите корректный адрес сайта (вида: example.ru)"
    ...
    - Сайты. При добавлении пикселя, при вводе некорректного email в поле "Email владельца" и нажатии кнопки "Запросить доступ" появляется ошибка "Неверный email"
...
2. Страница со списком пикселей
    ...
    - Сайты. При вводе любого из набора символов `$№^\| в поле названия пикселя, при переименовании пикселя появляется ошибка "Разрешены буквы, цифры и символы _+/=&!@*:%.,?;~#'"()[]{}-"
