...
<ol>
    ...
    <li>
        ...
        <ul>
            ...
            <img src="https://github.com/user-attachments/assets/a4ce5e69-ee17-4d92-a21f-dcb8d439330e"/>
            </li>
    ...
    <li>
        ...
        <li>
            <ul>
                <li>Лид-формы. Форма создания лид-формы. При отсутствии ввода в полях "Название", "Логотип", "Название компании", "Заголовок", "Описание формы" и нажатии кнопки "Продолжить" отображаются сообщения об ошибках
...
<ol>
    <li>
        ...
        <ul>
            <li>При нажатии иконки "Поделиться" открывается попап выбора ключа шейринга (Публичный или Приватный).
            <img src="https://github.com/user-attachments/assets/7629957e-bb01-4fe0-9850-3a5bc2ffbbef"/>
</li>
    ...
    <li>
        Список Аудиторий
        <img src="https://github.com/user-attachments/assets/a3acf3fd-fcdc-458d-95db-f5ae5a4cde26"/>
        <ul>
    ...
    <li>
        Аудитории. Создание.
        <img src="https://github.com/user-attachments/assets/14ab8599-a741-4850-be40-2faca20d7075"/>
        <ul>
    ...
    <li>
        ...
        <img src="https://github.com/user-attachments/assets/6712f380-7154-4112-9232-a5e356cd9b77"/>
        <ul>
    ...
    <li>
        ...
        <img src="https://github.com/user-attachments/assets/5c7aaf76-b85a-43dc-8a21-c996904de887"/>
        <ul>
            <li>Нельзя добавлять файлы форматов, отличающихся от txt и csv</li>
            <li>При добавлении файла, не отвечающего требованиям (размер списка: не менее 100 уникальных записей, одна запись в строке, разделитель: перевод строки, кодировка: UTF-8, вес файла: до 128 Мб), отображаются сообщения об ошибках при парсинге файла</li>
...
<ol>
    <li>
        Попап выбора кейса
        <img src="https://github.com/user-attachments/assets/79338fb0-8a53-4f75-b703-2db2ae9cdbc0"/>
        <ul>
    ...
    <li>
        ...
        <img src="https://github.com/user-attachments/assets/4b8d2d47-424a-44ad-b5e5-640076990f2a"/>
        <ul>
    ...
    <li>
        ...
        <img src="https://github.com/user-attachments/assets/ef9cb933-83ea-4ac8-839f-6dbe84177eca"/>
        <ul>
