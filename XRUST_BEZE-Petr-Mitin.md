    ...
    <li>
        ...
        <ul>
            <li>При нажатии кнопки "Фильтр" открывается попап фильтров. 
                ![image](https://github.com/user-attachments/assets/295bdbf2-cc58-4426-bfce-fe47f4f8be99)
            </li>
            <li>При нажатии кнопки "Сохранить" открывается попап сохранения фильтра
            ![image](https://github.com/user-attachments/assets/1219360d-0d0f-4476-b45b-234e54995e1b)
            </li>
