...
<ul>
    ...
    <li>
        ...
        <ol>
            ...
            <li>Обзор. Избранное. Можно отображать на графиках метрики из разделов на рисунке ![favorite_graphics](https://github.com/user-attachments/assets/04ef9636-2ae1-4399-bca0-e1fd4decd3a6)
</li>
        </ol>
    </li>
</ul>
...
<ol>
    ...
    <li>
        Список Аудиторий
        <ul>
            <li>Фильтр. При выборе категорий из списка отображаются только аудитории, относящиеся к этим категориям ![auditory_filter](https://github.com/user-attachments/assets/d680649e-bc88-4b6a-a034-e8b8ae2b6e09)
</li>
