...
Ввод названия сообщества. При нахождении сообществ отображается их список.

6. Создание аудитории. Нажатие на кнопку "Добавить источник". Включить источник "Подписчики сообществ".
Ввод названия сообщества. Если сообщества нету, то выводится сообщение "Ничего не нашлось".

![alt text](img/Аудитории_ничего_не_нашлось.png)


7. Аудитории. При наведении на аудиторию появляется троеточие. При наведении на троеточие появляются варианты: "Редактировать", "Настроить доступ", "Удалить".

![alt text](img/Редактирование_аудитории.png)

8. Аудитории. При нажатии на кнопку "Удалить" и подтверждения Аудитория удаляется.
...
5. Добавление пикселя. Ввод корректного домена (с окончанием через .ru например), появляется окно об успешном создании пикселя.
В списке пикселей отображается созданный пиксель.

6. Редактирование названия пикселя. При наведении на пиксель в списке, появляется троеточие. При нажатии на троеточие появляются варианты "Переименовать", "Удалить". При нажатии на вариант переименовать появляется окно для ввода нового названия. Если название больше 255 символов, в нижнем левом углу появляется ошибка "Внутренняя ошибка сервера". 

7. Редактирование названия пикселя. При наведении на пиксель в списке, появляется троеточие. При нажатии на троеточие появляются варианты "Переименовать", "Удалить". При нажатии на вариант переименовать появляется окно для ввода нового названия. Если название меньше 255 символов - у пикселя изменяется название, после обновления страницы видно изменение.

8. Удаление пикселя. При нажатии на вариант удалить и подтверждении удаления пиксель удаляется и пропадает из списка пикселей.
...
1. Личный кабинет. При нажатии на кнопку в меню "Настройки" открывается окно с настройками. https://ads.vk.com/hq/settings

![alt text](img/Настройки_общие.png)

2. Настройки. Общие. Проверка отображения. Контакты: поля "Телефон", "Email", кнопка "Добавить Email". 

3. Настройки. Общие. Проверка отображения. Реквизиты: поля: "ФИО", "ИНН".

4. Настройки. Общие. Проверка отображения. Интерфейс: поля: "Название кабинета", "Язык интерфейса", "галочка" -  "распознавать горячие клавиши". Связанные кабинеты. кнопка: "Привязать кабинет myTarget".

5. Настройки. Общие. Проверка отображения. Доступ к API. Ссылка "Запросить доступ к API"

6. Настройки. Общие. Проверка отображения. Кнопки "Выйти из других устройств", "Удалить кабинет".

7. Настройки. Уведомления. https://ads.vk.com/hq/settings/notifications Проверка отображения.
![alt text](img/Настройки_уведомления.png)

8. Настройки. Права доступа. https://ads.vk.com/hq/settings/access Проверка отображения.
![alt text](img/Настройки_уведомления.png)

9. Настройки. История изменений. https://ads.vk.com/hq/settings/logs Проверка отображения.